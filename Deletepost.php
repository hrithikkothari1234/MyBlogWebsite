    ...
    <div class="container-fluid">
     ...
     <div>  <?php       echo message(); echo successmessage();  ?>  </div>
        ...
        <div>
          ...
          <form action="Deletepost.php?Delete=<?php echo $Searchparameter; ?>" method="post" enctype="multipart/form-data">
            <fieldset>
              <div class="form-group">
              <label for="title"> <span class="fieldnfo"> Title: </span></label>
              <input disabled value="<?php echo $UpdateTitle; ?>"class="form-control"type="text" name="Title" id="title" placeholder="Title">
            </div>
            <div class="form-group">
              <span class="fieldnfo"> Existing Category: </span>
              <?php echo $UpdateCategory; ?>
              <br>
            <label for="categoryselect"> <span class="fieldnfo"> </span></label>
            ...
            <br>
            <label for="imageselect"> <span class="fieldnfo">  </span></label>
          ...
          <textarea disabled class="form-control" name="Post" id="postarea">
            ...
            <input class="btn btn-danger btn-block" type="submit" name="submit" value="Delete Post"><br> <br>
